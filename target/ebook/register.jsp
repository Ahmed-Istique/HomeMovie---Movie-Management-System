...
<body>
	<nav>
		...
		<div>
			<a href="login.jsp"><i class="fa-solid fa-right-to-bracket"> Login </i></a>
			<a href="register.jsp"><i class="fa-solid fa-user-plus"> Signupi </i></a>
		</div>
	</nav>

	<h2>Register <i class="fa-solid fa-user-plus"></i></h2>
